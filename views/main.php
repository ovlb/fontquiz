	...
	<section id="options">
		<div class="row clearfix">
			...
			<div class="col third" id="input-letter">
				<h4>Which</h4>
				<input id="letter-e" type="radio" name="letter" value="e"><label for="letter-e">e</label>
				<input id="letter-amp" type="radio" name="letter" value="amp"><label for="letter-amp">&amp;</label>
				<input id="letter-a" type="radio" name="letter" value="a"><label for="letter-a">a</label>
